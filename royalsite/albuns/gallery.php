...
if ( isset( $_GET['id'] ) )
{
    ...
    if ( $db->rows >= 1 )
    {
        ...
        echo "<h1 style=\"color:white;\">" .  $album_name  . "</h1>\n";
        echo "<a style=\"color:white;\" href=\"album.php\" class=\"back\"><img src=\"images/left.png\"/> Voltar</a>";
        ...
        foreach ( $db->data as $fotos )
        {
            ...
            <div class="box-detail" id="<?= $f->foto_id ?>">
                ...
                <div class="box-bottom">
                    ...
                    {
                        ?>
                        <div class="box-bottom-right"><?= $data ?> dia(s) atr&aacute;s</div>
                        <?php
                    }
                    ?>
                </div>		
...
{
    echo "<h1 style=\"color:white;\"> Selecione um &Aacute;lbum</h1> <br />\n";
