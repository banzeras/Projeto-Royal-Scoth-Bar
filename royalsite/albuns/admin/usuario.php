...
<html>
    <head>  
        <title>Gallery - Admin Royal</title>  
    ...
    <body>	
        <div id="status-bar">
            <div class="container_12">
                <ul id="status-infos">
                    <li class="spaced">Gallery Royal :: <strong> <a href="http://facebook.com/anderson.augusto.716195"> Anderson Rezende</a></strong></li>
                </ul>                          
            </div>        
        </div> 
            ...
            <div class="grid_12">
                ...
                <div class="block-border">
                    <div class="block-content">
                        <h1>&Aacute;rea Restrita - Usu&aacute;rios
                            <?php
                            if ( !isset( $_GET['action'] ) && !isset( $_GET['edit'] ) )
                            {
                                ?>
                                <a href="usuario.php?action=novo" class="with-tip"  title="Incluir Novo Usu&aacute;rio">
                                    <img src="tpl/images/plus-circle-blue.png" width="16" height="16"> 
                                    Incluir Usu&aacute;rio
                                </a>                        
                                <?php
                            }
                            else
                        ...
                        <div class="block-controls">
                            <ul class="controls-tabs js-tabs with-children-tip">
                                ...
                                <li><a href="album.php" title="&Aacute;lbuns">
                                        <img src="tpl/images/icons/gallery.png" width="24" height="24"></a>
                                </li>

                                <li class="current"><a href="usuario.php" title="Usu&aacute;rios">
                            ...
                            if ( isset( $_GET['action'] ) && $_GET['action'] == 'novo' )
                            {
                                ...
                                <div id="home" style="min-height: 550px;">
                                    ...
                                    <div class="grid_6">
                                        ...
                                        <p class="message warning">Os campos marcados com (*) s&atilde;o de preenchimento obrigat&oacute;rio!</p>
                                        ...
                                        <form method="post" class="form" onsubmit="return valida()"
                                            ...
                                            <p>
                                                <button>Cadastrar Usu&aacute;rio</button>
                                            </p>
                                    ...
                                    <tbody>                              
                                        ...
                                        if ( $db->rows >= 1 )
                                        {
                                            foreach ( $db->data as $user )
                                            {
                                                ...
                                                echo "  <td> ";
                                                echo "<a class=\"with-tip edit\" title=\"editar usu&aacute;rio\" id=\"$u->user_id\" href=\"usuario.php?edit=$u->user_id\">";
                                                echo "<img src=\"tpl/images/pencil.png\" width=\"16\" height=\"16\">";
                                                echo "</a> &nbsp;";
                                                echo "<a class=\"with-tip delete\" title=\"remover usu&aacute;rio\"  id=\"$u->user_id\" href=\"usuario.php?action=remove&id=$u->user_id\">";
