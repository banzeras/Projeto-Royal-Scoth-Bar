	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
				...
				<form enctype="multipart/form-data" style="background-color:#F8F8FF; padding-top:10px;padding-right:5px;" class="navbar-form navbar-left" method="post" action="">
					  ...
					  <div class="form-group">
					   <label>Data do Evento:</label>
						<input type="text" id="data" name="data" onBlur="olhacampo2()" class="form-control" placeholder="Exemplo:02/Jan">
					  </div>
					  <br><hr>
					   <div class="form-group">
		...
		if(empty($evento) || empty($data) || empty($txtarea)){
						   echo "<p> Prencha os campos corretamente, verifique se algum deles nao permaneceu em branco !</p><br>" ;
							...
							$sql = "INSERT INTO eventos ( id_evento, nome_evento, data_evento, conteudo_evento, caminho_img) VALUES( '', '$evento', '$data', '$txtarea','$destino')";
							mysql_query($sql);	
							mysql_close($conexao);
